...
(1,NULL,'Gestion de empleado','Se gestionan los empleados del hotel',1),
(2,NULL,'Empleado','Prueba Empleado',1),
(3,NULL,'Gestion De Empleados','prueba permisos',1),
(4,NULL,'Empleados','Formulario de empleados',1),
(5,NULL,'Administracion','Formularios de administracion',1),
(6,NULL,'Modulos','Gestion de Modulos',1),
(7,NULL,'Prueba Dll','Prueba de cambios de Dll',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=631;
